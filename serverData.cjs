...
/* PODEMOS CONCATENAR ESTE SERVIDOR CON NUESTRO BACKEND, PERO TAMBIÉN HAY QUE MODIFICAR  DE ACUERDO A LOS ARCHIVOS QUE TENEMOS (RUTAS, CONTROLADORES, MODELOS, ETC) 
PORQUE PRACTICAMENTE TENEMOS LO MISMO EN AMBOS SERVIDORES */